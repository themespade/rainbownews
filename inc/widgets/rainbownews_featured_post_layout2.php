...
class Rainbownews_featured_post_layout2 extends WP_Widget
{
    ...
    function __construct()
    {
        $widget_ops = array(
            ...
            'description'    => __( 'Best for (Front Page: Top Area & Front Page: Bottom Area).', 'rainbownews' ) );
                        ...
                        <div class="nnc-category-single <?php echo has_post_thumbnail() ? '' : 'nnc-no-image'; ?>">
                            ...
                            <div class="nnc-category-dtl">
                                ...
                                <div class="nnc-entry-meta">
                                    ...
                                    <?php if ( $i == 1 ) { ?>
                                        <span class="author">By <a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta('ID') ) ); ?>" title="<?php the_author(); ?>"><?php  esc_html( the_author() ); ?></a></span>
                                    <?php } ?>
