...
function rainbownews_widgets_init()
{
    ...
    register_sidebar( array(
        ...
        'before_widget'     => '<section id="%1$s" class="widget %2$s wow fadeInUp animated" data-wow-delay="0.5s">',
...
if ( ! function_exists( 'rainbownews_breadcrumbs' ) ) :
    ...
    function rainbownews_breadcrumbs()
    {
        ...
        if ( $rainbownews_et_to == 1 ):
            ...
            $delimiter = balanceTags( '<span class="breadcrumb_separator"> <i class="fa fa-angle-right"></i> </span>' ) ; // delimiter between crumbs

            $home = balanceTags( '<i class="fa fa-home"></i>' ); // text for the 'Home' link
            ...
            if ( is_home() || is_front_page() ) {
                if ($showOnHome == 1) echo '<div id="rainbownews--breadcrumbs"><div class="nnc-top-breadcrumbs"><a href="' . esc_url( $homeLink ) . '" class="breadcrumb_home_text">' . balanceTags( $home ) . '</a></div></div>';
            }
            else {
                echo '<div id="rainbownews--breadcrumbs"><div class="nnc-top-breadcrumbs"><a href="' . esc_url( $homeLink ) . '" class="breadcrumb_home_text">' . balanceTags( $home ) . '</a>' . $delimiter . ' ';
